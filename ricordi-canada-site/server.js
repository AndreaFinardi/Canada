...
const COOKIE_DURATION_MS = 1000 * 60 * 60 * 12; // solo per sicurezza: il browser non salva più il dispositivo
...
app.post('/api/login', (req, res) => {
  ...
  res.cookie(COOKIE_NAME, createAccessToken(), {
    ...
    sameSite: 'lax',
    // Niente maxAge: il cookie non viene salvato come "ricorda dispositivo".
    // Inoltre il sito controlla la singola scheda del browser e richiede il codice ad ogni nuova apertura.
    path: '/'
  });
